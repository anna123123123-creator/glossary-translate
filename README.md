...
这个是做 **AI 翻译**产品时顺手做的免费小工具——只做"术语统一替换"这一步，不涉及真正的语言翻译。完整版是 AI 实时翻译、文档翻译、网页翻译，支持 100+ 语种，还能自定义术语库自动生效，源码在这：[全能源码 · AI 翻译网站源码](https://inzyxuashop.com/aifanyi-yuanma.html)。
